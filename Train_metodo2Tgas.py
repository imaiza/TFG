...
from MSRF7_monotarget2_fun import RF_train2
...
dfp_final2=dfp_final.drop(dfp_final.columns[[32,33,35,36]],axis=1)
...
dfp_final2=dfp_dimred.drop(dfp_dimred.columns[[13,9,10,12]],axis=1)
print(dfp_final2.columns)

targetname=['G3XMgas(80)','G3XMstar(81)' ,'G3XTgas_mw(82)', 'G3XYx(84)', 'G3XYsz(85)']
monotarget=['G3XTgas_mw(82)']



RF_train2(dfp_final2,monotarget, setname='New_Matched_Rockstar-G3X-snap_merge_data_Reduced_Dim')
